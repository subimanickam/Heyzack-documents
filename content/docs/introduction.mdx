...
description: "HeyZack Partner Portal helps authorized smart home installers manage leads, customers, installations, and handymen from a single dashboard."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Leads" icon="funnel" href="/leads/overview">
...
- **Lead pipeline** — capture inquiries, track quote status, and move prospects through a Kanban board or list view
